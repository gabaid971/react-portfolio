...
const Robot = () => {
    return (
        <div>
            ...
            care of the speed control of the robot.</h4><h4> To this end, we will present a method
            based on the resolution of a partially observable Markov decision process
            (POMDP), which will model the uncertainties on the directional intention of
